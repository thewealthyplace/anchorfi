...
describe("collateral-vault", () => {
  ...
  it("vault deposit test #20", () => {
    simnet.callPublicFn("collateral-vault", "deposit", [Cl.uint(690000000)], wallet1);
    const { result } = simnet.callReadOnlyFn("collateral-vault", "get-vault", [Cl.principal(wallet1)], wallet1);
    expect(result).toBeOk(expect.anything());
  });

  it("vault deposit test #21", () => {
    simnet.callPublicFn("collateral-vault", "deposit", [Cl.uint(700000000)], wallet1);
    const { result } = simnet.callReadOnlyFn("collateral-vault", "get-vault", [Cl.principal(wallet1)], wallet1);
    expect(result).toBeOk(expect.anything());
  });

  it("vault deposit test #22", () => {
    simnet.callPublicFn("collateral-vault", "deposit", [Cl.uint(710000000)], wallet1);
    const { result } = simnet.callReadOnlyFn("collateral-vault", "get-vault", [Cl.principal(wallet1)], wallet1);
    expect(result).toBeOk(expect.anything());
  });

  it("vault deposit test #23", () => {
    simnet.callPublicFn("collateral-vault", "deposit", [Cl.uint(720000000)], wallet1);
    const { result } = simnet.callReadOnlyFn("collateral-vault", "get-vault", [Cl.principal(wallet1)], wallet1);
    expect(result).toBeOk(expect.anything());
  });

  it("vault deposit test #24", () => {
    simnet.callPublicFn("collateral-vault", "deposit", [Cl.uint(730000000)], wallet1);
    const { result } = simnet.callReadOnlyFn("collateral-vault", "get-vault", [Cl.principal(wallet1)], wallet1);
    expect(result).toBeOk(expect.anything());
  });

  it("vault deposit test #25", () => {
    simnet.callPublicFn("collateral-vault", "deposit", [Cl.uint(740000000)], wallet1);
    const { result } = simnet.callReadOnlyFn("collateral-vault", "get-vault", [Cl.principal(wallet1)], wallet1);
    expect(result).toBeOk(expect.anything());
  });

  it("vault deposit test #26", () => {
    simnet.callPublicFn("collateral-vault", "deposit", [Cl.uint(750000000)], wallet1);
    const { result } = simnet.callReadOnlyFn("collateral-vault", "get-vault", [Cl.principal(wallet1)], wallet1);
    expect(result).toBeOk(expect.anything());
  });

  it("vault deposit test #27", () => {
    simnet.callPublicFn("collateral-vault", "deposit", [Cl.uint(760000000)], wallet1);
    const { result } = simnet.callReadOnlyFn("collateral-vault", "get-vault", [Cl.principal(wallet1)], wallet1);
    expect(result).toBeOk(expect.anything());
  });

  it("vault deposit test #28", () => {
    simnet.callPublicFn("collateral-vault", "deposit", [Cl.uint(770000000)], wallet1);
    const { result } = simnet.callReadOnlyFn("collateral-vault", "get-vault", [Cl.principal(wallet1)], wallet1);
    expect(result).toBeOk(expect.anything());
  });
